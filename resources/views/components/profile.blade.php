<x-layout :doctitle="$post->title" :doctitle="$doctitle">
    ...
    <div class="container py-md-5 container--narrow">
        <h2>
          ...
          @if(!$sharedData['currentlyFolowing'] AND auth()->user()->username != $sharedData['username'])
          ...
          @if($sharedData['currentlyFolowing'])
